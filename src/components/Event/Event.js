    ...
    return (
       ...
       <div className={eventClass} onClick={onClick}>
           ...
           <p className={styles.eventTime}>
               {kumPlan[index].startHour === 0 ? kumPlan[index].startHour + "0" : kumPlan[index].startHour}:{kumPlan[index].startMinute <= 9 ? "00" : kumPlan[index].startMinute}-{kumPlan[index].endHour}:{ (kumPlan[index].endMinute === 0) ? "00" : kumPlan[index].endMinute }
           </p>
